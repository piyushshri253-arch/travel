...
const packages = [
  {
    ...
    days: "6N/7D",
    img: "/honeymoon/balitour1.jpg",
    slug: "romantic-bali-tour-package-6n-7d",
    type: "honeymoon",
  },
  {
    title: "Dreamy Honeymoon Tour Package to Bali",
    days: "5N/6D",
    img: "/honeymoon/balitour2.jpg",
    slug: "dreamy-honeymoon-tour-package-5n-6d",
    type: "honeymoon",
  },
  {
    title:
      "Romantic Escapade To The Tropical Paradise - Honeymoon Bali Tour Package",
    days: "7N/8D",
    img: "/honeymoon/balitour4.jpg",
    slug: "romantic-escapade-bali-7n-8d",
    type: "honeymoon",
  },
  {
    title: "Honeymoon Bali Tour Package from India (Flights Included)",
    days: "8N/9D",
    img: "/honeymoon/balitour5.jpg",
    slug: "honeymoon-bali-package-from-india-8n-9d",
    type: "honeymoon",
  },
  {
    title: "Tropical Romance - Couple Special Bali Tour Package",
    days: "7N/8D",
    img: "/honeymoon/balitour6.jpg",
    slug: "tropical-romance-bali-7n-8d",
    type: "honeymoon",
  },
  {
    title: "Dreamy Honeymoon Bali Tour Package",
    days: "6N/7D",
    img: "/honeymoon/balitour7.jpg",
    slug: "dreamy-honeymoon-bali-6n-7d",
    type: "honeymoon",
  },
  {
    title: "Blissful Honeymoon Bali Tour Package From India",
    days: "8N/9D",
    img: "/honeymoon/balitour8.jpg",
    slug: "blissful-honeymoon-bali-8n-9d",
    type: "honeymoon",
  },
  {
    title: "Best Honeymoon Bali Tour Package For 6 Days",
    days: "5N/6D",
    img: "/honeymoon/balitour9.jpg",
    slug: "best-bali-honeymoon-5n-6d",
    type: "honeymoon",
  },
];
          ...
          {packages.map((item, i) => (
            ...
            >
              ...
              <div className="p-3 sm:p-4">
                <h3 className="text-xs sm:text-sm md:text-base font-semibold mb-2 text-gray-800 leading-snug">
                  {item.title}
                </h3>
                ...
                <div className="flex items-center text-[10px] sm:text-xs text-gray-500 gap-2 mb-2">
                  ...
                  <span className="flex items-center gap-1">
                    <MapPin size={12} /> Denpasar Airport
                  </span>
                </div>
