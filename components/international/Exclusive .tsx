  ...
  return (
    <section className={styles.section}>
      <div className={styles.header}>
        <h2>Exclusive Europe Summer Deals 2026

</h2>
        <p>
          Spend a perfect summer soaking in the scenic landscapes of Europe with best experiences, outdoor activities, city tours and adventures.
