  ...
  return (
    <section className={styles.section}>
      <div className={styles.header}>
        <h2>Popular Backpacking Europe Tours
</h2>
        <p>
          Travel Europe the classic backpacking way, hopping iconic cities, meeting travellers from around the world, and making lifetime memories.
